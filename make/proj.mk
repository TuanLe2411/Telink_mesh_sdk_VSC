...
$(OUT_PATH)/proj/app/%.o: $(TEL_PATH)/firmware/proj/app/%.c
	@echo 'Building file: $<'
...
# Each subdirectory must supply rules for building sources it contributes
$(OUT_PATH)/proj/common/%.o: $(TEL_PATH)/firmware/proj/common/%.c
	@echo 'Building file: $<'
	@tc32-elf-gcc $(GCC_FLAGS) $(INCLUDE_PATHS) -c -o"$@" "$<"
...
# Each subdirectory must supply rules for building sources it contributes
$(OUT_PATH)/proj/mcu/%.o: $(TEL_PATH)/firmware/proj/mcu/%.c
	@echo 'Building file: $<'
	@tc32-elf-gcc $(GCC_FLAGS) $(INCLUDE_PATHS) -c -o"$@" "$<"
