...
$(OUT_PATH)/vendor/common/beacon.o \
...
$(OUT_PATH)/vendor/common/user_du.o \
$(OUT_PATH)/vendor/common/user_proc.o \
$(OUT_PATH)/vendor/common/vendor_model.o 
# Each subdirectory must supply rules for building sources it contributes
$(OUT_PATH)/vendor/common/%.o: $(TEL_PATH)/firmware/vendor/common/%.c $(common_dir)
	@echo 'Building file: $<'
...
# Each subdirectory must supply rules for building sources it contributes
$(OUT_PATH)/vendor/common/nl_api/%.o: $(TEL_PATH)/firmware/vendor/common/nl_api/%.c
	@echo 'Building file: $<'
	@tc32-elf-gcc $(GCC_FLAGS) $(INCLUDE_PATHS) -c -o"$@" "$<"
...
$(OUT_PATH)/vendor/common/mi_api/i2c_msc.o 
# Each subdirectory must supply rules for building sources it contributes
$(OUT_PATH)/vendor/common/mi_api/%.o: $(TEL_PATH)/firmware/vendor/common/mi_api/%.c
	@echo 'Building file: $<'
	@tc32-elf-gcc $(GCC_FLAGS) $(INCLUDE_PATHS) -c -o"$@" "$<"
...
$(OUT_PATH)/vendor/common/mi_api/libs/%.o: $(TEL_PATH)/firmware/vendor/common/mi_api/libs/%.c
	@echo 'Building file: $<'
	@tc32-elf-gcc $(GCC_FLAGS) $(INCLUDE_PATHS) -c -o"$@" "$<"
...
OBJS += $(OUT_PATH)/vendor/common/mi_api/mijia_ble_api/mible_api.o
# Each subdirectory must supply rules for building sources it contributes
$(OUT_PATH)/vendor/common/mi_api/mijia_ble_api/%.o: $(TEL_PATH)/firmware/vendor/common/mi_api/mijia_ble_api/%.c
	@echo 'Building file: $<'
	@tc32-elf-gcc $(GCC_FLAGS) $(INCLUDE_PATHS) -c -o"$@" "$<"
...
# Each subdirectory must supply rules for building sources it contributes
$(OUT_PATH)/vendor/common/mi_api/libs/third_party/micro-ecc/%.o: $(TEL_PATH)/firmware/vendor/common/mi_api/libs/third_party/micro-ecc/%.c
	@echo 'Building file: $<'
	@tc32-elf-gcc $(GCC_FLAGS) $(INCLUDE_PATHS) -c -o"$@" "$<"
